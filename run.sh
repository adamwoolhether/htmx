...
wgo run -xdir=hyperview -xdir=vendor -file=.go -file=.templ -file=.css -file=.js -xfile=_templ.go -verbose go/app/main.go | go run go/app/tooling/main.go &
PID1=$!
printf "wgo\t\tPID: %s\n" $PID1
